...
INSERT INTO `policy_category` VALUES (1,'Life Insurance',NULL,'Life Insurance Plan'),(5,'Health Insurance',NULL,'Health insurance desc fetaures'),(7,'Motor Insurance',NULL,'Motor insurance is a coverage which is bought for cars, trucks and other vehicles that ply on roads.'),(8,'Travel Insurance','2016-12-15','Cashless hospitalization Coverage for baggage loss Wide range of cover – up to $1 million Cover starting from Rs. 260*');
